...
class DefaultToolTipAnimator implements ToolTipAnimator {
  ...
  @Override
  public ObjectAnimator popout(
      final View view, final long duration, final AnimatorListenerAdapter animatorListenerAdapter) {
    ObjectAnimator popout =
        ObjectAnimator.ofPropertyValuesHolder(
            view,
