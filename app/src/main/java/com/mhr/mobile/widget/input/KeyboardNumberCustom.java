...
public class KeyboardNumberCustom extends LinearLayout implements View.OnClickListener {
  ...
  private MaterialCardView btnSelesai;
  private EditText targetEditText; // Tambahkan EditText sebagai target
  private Handler handler = new Handler();
  private Runnable deleteRunnable;

  public KeyboardNumberCustom(Context context) {
    super(context);
    initialization(context);
  }

  public KeyboardNumberCustom(Context context, @Nullable AttributeSet attrs) {
    super(context, attrs);
  ...
  public KeyboardNumberCustom(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    super(context, attrs, defStyleAttr);
    initialization(context);
  }

  private void initialization(Context context) {
    LayoutInflater.from(context).inflate(R.layout.keyboard_number_custom, this, true);
  ...
  public EditText getTargetEditText(){
	  return targetEditText;
  }

  public void setOnSelesaiClickListener(OnClickListener listener) {
    btnSelesai.setOnClickListener(listener);
  }

  public void setEnabledBtnSelesai(boolean enabled) {
    btnSelesai.setEnabled(enabled);

    if (enabled) {
      btnSelesai.setCardBackgroundColor(QiosColor.getColor(getContext(), R.color.me_blue));
    } else {
      btnSelesai.setCardBackgroundColor(QiosColor.getColor(getContext(), R.color.color_gray_inactive));
    }
  }
