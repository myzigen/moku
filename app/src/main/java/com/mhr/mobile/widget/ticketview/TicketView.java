...
public class TicketView extends FrameLayout {
  ...
  private int mViewID;
  private View mView;
  private @DividerLocation int mDividerLocation;

  private @PunchLocation int mPunchLocation;
  ...
  @IntDef({
    ...
    DividerLocation.TOP,
    DividerLocation.BOTTOM,
    DividerLocation.LEFT,
    DividerLocation.RIGHT
  })
  ...
  private float mBottomDividerStartX,
      mBottomDividerStartY,
      mBottomDividerStopX,
      mBottomDividerStopY;
    ...
    if (mOrientation == Orientation.VERTICAL) {
      ...
      if (mView != null) {
        if (mDividerLocation == (mDividerLocation | DividerLocation.TOP)) {
          ...
          mRect.set(
              left - mScallopRadius,
              mView.getTop() - mScallopRadius,
              left + mScallopRadius,
              mScallopRadius + mView.getTop());
        ...
        if (mDividerLocation == (mDividerLocation | DividerLocation.BOTTOM)) {
          ...
          mRect.set(
              left - mScallopRadius,
              mView.getBottom() - mScallopRadius,
              left + mScallopRadius,
              mScallopRadius + mView.getBottom());
      ...
      if (mPunchLocation == (mPunchLocation | PunchLocation.TOP)) {
        ...
        mRect.set(
            ((getRight() - getLeft()) / 2f) - mPunchRadius,
            top - (mPunchRadius * 1.5f),
            ((getRight() - getLeft()) / 2f) + mPunchRadius,
            top + (mPunchRadius / 1.5f));
      ...
      if (mView != null) {
        if (mDividerLocation == (mDividerLocation | DividerLocation.LEFT)) {
          ...
          mRect.set(
              mView.getLeft() - mScallopRadius,
              bottom - mScallopRadius,
              mScallopRadius + mView.getLeft(),
              bottom + mScallopRadius);
        ...
        if (mDividerLocation == (mDividerLocation | DividerLocation.RIGHT)) {
          ...
          mRect.set(
              mView.getRight() - mScallopRadius,
              bottom - mScallopRadius,
              mScallopRadius + mView.getRight(),
              bottom + mScallopRadius);
      ...
      if (mPunchLocation == (mPunchLocation | PunchLocation.LEFT)) {
        ...
        mRect.set(
            left - (mPunchRadius * 1.5f),
            ((getBottom() - getTop()) / 2f) - mPunchRadius,
            (mPunchRadius / 1.5f) + left,
            ((getBottom() - getTop()) / 2f) + mPunchRadius);
      ...
      if (mPunchLocation == (mPunchLocation | PunchLocation.RIGHT)) {
        ...
        mRect.set(
            right - (mPunchRadius / 1.5f),
            ((getBottom() - getTop()) / 2f) - mPunchRadius,
            (mPunchRadius * 1.5f) + right,
            ((getBottom() - getTop()) / 2f) + mPunchRadius);
  ...
  private void init(AttributeSet attrs) {
    if (attrs != null) {
      ...
      mOrientation =
          typedArray.getInt(R.styleable.TicketView_ticketOrientation, Orientation.HORIZONTAL);
      mBackgroundColor =
          typedArray.getColor(
      ...
      mScallopRadius =
          typedArray.getDimensionPixelSize(
              R.styleable.TicketView_ticketScallopRadius, AndroidViews.dpToPx(20f, getContext()));
      mShowBorder = typedArray.getBoolean(R.styleable.TicketView_ticketShowBorder, false);
      mBorderWidth =
          typedArray.getDimensionPixelSize(
              R.styleable.TicketView_ticketBorderWidth, AndroidViews.dpToPx(2f, getContext()));
      mBorderColor =
          typedArray.getColor(
      ...
      mDividerType =
          typedArray.getInt(R.styleable.TicketView_ticketDividerType, DividerType.NORMAL);
      mDividerDesign =
          typedArray.getInt(R.styleable.TicketView_ticketDividerDesign, DividerDesign.COLOR);
      mDividerWidth =
          typedArray.getDimensionPixelSize(
              R.styleable.TicketView_ticketDividerWidth, AndroidViews.dpToPx(2f, getContext()));
      mDividerColor =
          typedArray.getColor(
      ...
      mDividerDashLength =
          typedArray.getDimensionPixelSize(
              R.styleable.TicketView_ticketDividerDashLength, AndroidViews.dpToPx(8f, getContext()));
      mDividerDashGap =
          typedArray.getDimensionPixelSize(
              R.styleable.TicketView_ticketDividerDashGap, AndroidViews.dpToPx(4f, getContext()));
      mCornerType = typedArray.getInt(R.styleable.TicketView_ticketCornerType, CornerType.NORMAL);
      mCornerRadius =
          typedArray.getDimensionPixelSize(
              R.styleable.TicketView_ticketCornerRadius, AndroidViews.dpToPx(4f, getContext()));
      mDividerPadding =
          typedArray.getDimensionPixelSize(
              R.styleable.TicketView_ticketDividerPadding, AndroidViews.dpToPx(10f, getContext()));
      mViewID = typedArray.getResourceId(R.styleable.TicketView_view, -1);
      mDividerLocation =
          typedArray.getInt(R.styleable.TicketView_ticketDividerLocation, DividerLocation.NONE);
      mPunchLocation =
          typedArray.getInt(R.styleable.TicketView_ticketPunchLocation, PunchLocation.NONE);
      mPunchRadius =
          typedArray.getDimensionPixelSize(
              R.styleable.TicketView_ticketPunchRadius, AndroidViews.dpToPx(20f, getContext()));
      float elevation = 0f;
  ...
  private void initElements() {
    ...
    if (mDividerWidth > mScallopRadius) {
      ...
      if (BuildConfig.DEBUG)
        Log.w(
            TAG,
            "You cannot apply divider width greater than scallop radius. Applying divider width to"
                + " scallop radius.");
    }
    ...
    if (mDividerDesign == DividerDesign.COLOR) setDividerPaintAsColor();
    else setDividerPaintAsPunchThrough();
  ...
  private void setDividerPaintAsPunchThrough() {
    ...
    if (mDividerType == DividerType.DASH)
      mDividerPaint.setPathEffect(
          new DashPathEffect(
              new float[] {(float) mDividerDashLength, (float) mDividerDashGap}, 0.0f));
    else mDividerPaint.setPathEffect(new PathEffect());
  ...
  private RectF getTopLeftCornerScallopArc(float top, float left) {
    mScallopCornerArc.set(
        left - mCornerRadius, top - mCornerRadius, left + mCornerRadius, top + mCornerRadius);
    return mScallopCornerArc;
  }

  private RectF getTopRightCornerScallopArc(float top, float right) {
    mScallopCornerArc.set(
        right - mCornerRadius, top - mCornerRadius, right + mCornerRadius, top + mCornerRadius);
    return mScallopCornerArc;
  }

  private RectF getBottomLeftCornerScallopArc(float left, float bottom) {
    mScallopCornerArc.set(
        left - mCornerRadius, bottom - mCornerRadius, left + mCornerRadius, bottom + mCornerRadius);
    return mScallopCornerArc;
  }
  ...
  private void setShadowBlurRadius(float elevation) {
    ...
    float maxElevation = AndroidViews.dpToPx(24f, getContext());
    mShadowBlurRadius = Math.min(25f * (elevation / maxElevation), 25f);
    //        mShadowBlurRadius = AndroidViewss.dpToPx(50f, getContext());
  }
